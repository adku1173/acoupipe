            ...
            for mode in modes:
                for tasks in task_list:
                    for feature in features:
                        for f in freqs:
                            if (mode != 'welch' and 'time_data' in feature) or (
                                mode != 'welch' and 'spectrogram' in feature
                            ):
                                continue
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--datasets', type=str, nargs='+', default=['DatasetSynthetic'], choices=['DatasetSynthetic', 'DatasetMIRACLE']
    )
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        default=['spectrogram', 'sourcemap', 'csmtriu', 'csm', 'eigmode', 'time_data'],
    )
    ...
    parser.add_argument('--size', type=int, default=100, help='Total number of samples to simulate')
    ...
    parser.add_argument(
        '--srirdir', type=str, default=None, help='Path to the SRIR directory (only necessary for DatasetMIRACLE)'
    )
    parser.add_argument(
