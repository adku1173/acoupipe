...
def main(
    ...
    if dataset == 'dataset1':
        from acoupipe.datasets import dataset1 as ds
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default="dataset1", choices=["dataset1"],
                        help="Which dataset split to compute ('training' or 'validation')")
    ...
    parser.add_argument('--features', nargs="+", default=["csm"], choices=["sourcemap", "csmtriu", "csm", "ref_cleansc"],
                        help="Whether to compute data set containing the csm or the beamforming map as the main features. Default is 'csm'")
    ...
    parser.add_argument('--num', type=int, default=0,
                        help="bandwidth of the considered frequencies")
    ...
    parser.add_argument('--name', type=str, default=None,
                        help="filename of simulated data. Default is './datasets' in the current working directory")
    ...
    parser.add_argument('--config', type=str, default=None,
                        help="an optional config.yml file specifying underlying parameters.")    
