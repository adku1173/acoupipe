...
#%%
from acoupipe.datasets.synthetic import DatasetSyntheticReverb

dataset = DatasetSyntheticReverb(mode="wishart")
...
fig.savefig(dpath / "reverb_sourcemap.png", dpi=300)
